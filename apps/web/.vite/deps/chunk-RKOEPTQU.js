// ../../node_modules/tldraw/dist-esm/lib/utils/svg/sanitizeSvg.mjs
...
var BLOCKED_HTML_TAGS = /* @__PURE__ */ new Set([
  "script",
  "iframe",
  "object",
  "embed",
...
var ALLOWED_HTML_ATTRS = /* @__PURE__ */ new Set([
  "class",
  "dir",
  "href",
  // only on <a>
...
var DATA_ATTR_PATTERN = /^data-/;
var ARIA_ATTR_PATTERN = /^aria-/;
var INVISIBLE_WHITESPACE = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g;
var SAFE_LINK_PROTOCOLS = /^(?:https?:|mailto:)/i;
var DATA_URI = /^data:/i;
var RASTER_DATA_URI = /^data:image\/(?:png|jpeg|jpg|gif|webp|avif|bmp|tiff|x-icon|vnd\.microsoft\.icon)[;,]/i;
...
var SAFE_CSS_DATA_MIME = /^data:(?:image\/(?:png|jpeg|jpg|gif|webp|avif)|font\/(?:woff2?|opentype|truetype|sfnt)|application\/(?:x-font-woff|font-woff2?|x-font-ttf|x-font-opentype|font-sfnt))[;,]/i;
...
var ANIMATION_TAGS = /* @__PURE__ */ new Set(["animate", "set", "animatecolor", "animatetransform"]);
var DANGEROUS_ANIMATION_TARGETS = /^(?:href|xlink:href|on)/i;
...
var URL_BEARING_SVG_ATTRS = /* @__PURE__ */ new Set([
  "clip-path",
  "cursor",
  "fill",
  "filter",
...
//# sourceMappingURL=chunk-RKOEPTQU.js.map
