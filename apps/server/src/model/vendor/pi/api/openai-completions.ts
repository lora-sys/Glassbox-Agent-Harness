...
function parseChunkUsage(
  ...
  const usage: AssistantMessage["usage"] = {
    reported: {
      input: typeof rawUsage.prompt_tokens === "number",
      output: typeof rawUsage.completion_tokens === "number",
      cacheRead:
        rawUsage.prompt_tokens_details?.cached_tokens != null ||
        rawUsage.prompt_cache_hit_tokens != null ||
        rawUsage.cached_tokens != null,
      cacheWrite: rawUsage.prompt_tokens_details?.cache_write_tokens != null,
      reasoning: rawUsage.completion_tokens_details?.reasoning_tokens != null,
    ...
    totalTokens: rawUsage.total_tokens ?? input + outputTokens + cacheReadTokens + cacheWriteTokens,
    cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0, total: 0 },
  };
